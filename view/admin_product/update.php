            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <img src="<?php echo Product::getImage($product['id']); ?>" width="200" height="249" alt="" />
                        ...
                        <select name="avaliability">
                            <option value="1" <?php if($product['avaliability'] == 1) echo 'selected="selected"'?>>Да</option>
                            <option value="0" <?php if($product['avaliability'] == 0) echo 'selected="selected"'?>>Нет</option>
                        </select>
